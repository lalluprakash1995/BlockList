...
public class DisplaySMSActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            editor.putString("SND",originNum);
            ...
            Log.e("MSGCONTENT",originNum);


            params.put("userid",Userid);
            Log.e("rrrrrrrrr",Userid);
            params.put("Phone",originNum);
            params.put("msg",msgContent);

            client.get("http://sicsglobal.co.in/Privacy_App/API/ReciveMesg.aspx?",params,new AsyncHttpResponseHandler()
            {
                @Override
